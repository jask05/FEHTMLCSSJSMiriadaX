...
const swipeTo = (getTo = '#menu_page') => {
     ...
     * Navegar con swipes
     */
    //COn un switch para paginas limitadas. 
    // switch (getTo) {
    //     case '#settings_page':
    //         swiper.slideTo(0);
    //         break;
    ...
    //         break;
    // }
    // Para muchas paginas Buscamos todas las paginas de swiper y buscamos la posicion en la que sta getTo en el array
    ...
    switch (animationType) {
        ...
        case 'fade_in':
            ...
            animation_layout.finished.then(() => {
                // Fake splash
                setTimeout(() => {
                    //Antes de la animación desactivamos el active del logo.active en la pantalla principal.active    
        ...
        case 'menu_to_game':
            ...
            break;
        case 'game_out':
            animation_ConfirmOut(getTo);     //Los incluimos por si estuvieran
            animation_PopupContinue(getTo);  //Los incluimos por si estuvieran
