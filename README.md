...
- Tema 1. VS Code. Construir menú horizontal con HTML y CSS
- Tema 2. HTML/CSS: Estructura CSS
- Tema 3. HTML/CSS: Texto e imagen
- Tema 4. Integración de objetos y de multimedia en HTML5

## Módulo 3. Introducción A ES6+, Let, VS Code, DOM, Boolean, If, Bucles, ..

- Tema 1. Introducción a JavaScript (ES6+) de cliente
- Tema 2. Programas, sentencias, var, let, const, y ops ++, --, +=, -=
- Tema 2b. Introducción a Visual Studio Code
- Tema 2c. Developer tools para depurar JavaScript de cliente
- Tema 2d. Visual Studio Code. Espacio de trabajo
- Tema 3. Scripts, funciones, objeto función, notación arrow y ámbitos
- Tema 4. Objetos, propiedades, métodos, DOM, eventos e interacción
- Tema 5. Booleanos, sentencias if-else, switch-case y bucles
- Tema 6. Arrays

## Módulo 4. Eventos, Objetos, Arrays, MVC, JSON, Boolean Y Storage API

- Tema 1. Eventos, DOM e interacción
- Tema 2. Más sobre Objetos: Literal de objetos, notación corchetes
- Tema 3. MVC: Eventos, modelo con objetos y arrays, vistas y controladores
- Tema 4. JSON (JavaScript Object Notation)
- Tema 5. Boolean y operadores relacionados: !, && y ||, ===, !==, etc.
- Tema 6. Almacenamiento en cliente: localStorage, sessionStorage

## Módulo 5. Tipos Y Clases, Herencia, Number, Multi-Asignación, Spread/Rest

- Tema 1. Tipos primitivos, clases predefinidas, typeof y belongsto
- Tema 2. Number: Literales de dec., hex., oct. y bin., NaN, Infinity
- Tema 3. Arrays: Asignación múltiple y spread/rest (...x)
- Tema 4. Objetos ES6+: Literal, multi-asignación y spread/rest (...x)
- Tema 5. Referencias a objetos: comparación, compartición
- Tema 6. Clases ES6 y Prototipos
- Tema 7. Herencia de Clases en ES6
- Tema 8. Ejecucion de programas: Eventos, bucle, cola, manejadores, timers

## Módulo 6. Strings, Iteradores Y Bucles, Programación Funcional Y Regexp

- Tema 1. Strings, códigos, UNICODE, literales, plantillas
- Tema 2. Iteradores y bucles: forEach, find-index, filter, map, reduce, for-in, for-of
- Tema 2. Ejercicios opcionales
- Tema 3. RegExp I: Búsqueda de patrones
- Tema 4. RegExp II: Repetición y alternativa
- Tema 5. RegExp III: Subpatrones y sustituciones

## Módulo 7. Excepciones, Promesas, Async/Await, HTTP, AJAX Y JQuery

- Tema 1. Excepciones, errores y sentencias throw y try-catch-finally
- Tema 2. Promesas I: new Promise(..), resolve, reject, async, await
- Tema 3. Promesas II: Orden de ejecución de instrucciones, then, catch
- Tema 4. HTTP: Protocolo, solicitudes, respuestas, métodos, MIME
- Tema 5. AJAX - Asynchronous JavaScript & XML
- Tema 6. MyJSON - AJAX - REST
- Tema 7. Librería jQuery y CDN Web

## Módulo 8. Arq. Información, UX, Wireframes, Iconos, SEO, SASS. @Media

- Tema 1. UX - a11y - Herramientas para a11y
- Tema 2a. Figma I. Arquitectura de información con Figma
- Tema 2b. Figma II. Arquitectura de información con Figma
- Tema 3. Figma III. Wireframes y prototipo con navegación
- Tema 4. Figma IV. Diseño de Interfaces Gráficas de Usuario
- Tema 5a. Incluir iconos: fuentes de iconos y SVGs
- Tema 5b. Incluir iconos: fuentes de iconos y SVGs
- Tema 6. Search Engine Optimization (SEO)
- Tema 7. Preprocesadores CSS
- Tema 8. Responsive Web Design con Preprocesadores

## Módulo 9. Transiciones, Animaciones CSS, SVG, Interacción Gestual, ..

- Tema 1. Transiciones y animaciones en CSS
- Tema 2. Gráficos Vectoriales en HTML y CSS
- Tema 3. Gráficos Vectoriales y uso de transiciones
- Tema 4. Interacción gestual en Interfaces Web
- Tema 5. Carruseles y transiciones entre páginas con la librería swiper.js
- Tema 6. Scroll animado con las librerías AOS y rellax.js
- Tema 7. Anime.JS
- Videotutorial P2P I. Saludo y explicación
- Videotutorial P2P II. Swiper y navegación
- Videotutorial P2P III. Animaciones entre pantallas
- Videotutorial P2P IV. Animación ventanas modales
- Videotutorial P2P V. Game over
- Videotutorial P2P VI. Despedida y siguientes pasos

## Módulo 10. PWAs. Desarrollando Aplicaciones Para Android/IOS/Escritorio

- Tema 1. Introducción a las PWAs
- Tema 2. PWAS. Utilidades
- Tema 3. Desarrollando una PWA
- Tema 3.1. Desarrollando una PWA. Lighthouse y descarga del código
- Tema 3.2. Desarrollando una PWA. Manifest.json
- Tema 3.3. Desarrollando una PWA. Service Worker
- Tema 3.4. Desarrollando una PWA. Install
- Tema 3.5. Desarrollando una PWA. Despliegue en Glitch
